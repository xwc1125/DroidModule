 ...
 */
public class MaterialDesginActivity extends ActionBarActivity {

    private RecyclerView mRecyclerView;

    private MaterialDesginAdapter myAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materialdesgin);
...
//        getActionBar().setTitle("那些年我们追的星女郎");
        ...
        // set adapter
        myAdapter = new MaterialDesginAdapter(this, actors);
