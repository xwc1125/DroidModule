...
import com.yuancy.framework.db.db.annotation.Column;
import com.yuancy.framework.db.db.converter.ColumnConverter;
import com.yuancy.framework.db.db.converter.ColumnConverterFactory;
import com.yuancy.framework.db.db.sqlite.ColumnDbType;
...
public final class ColumnEntity {
    private final static String TAG = ColumnEntity.class.getName();
