 ...
 * 
 * <p>
 * Title: PriorityAsyncTask
 * </p>
 * <p>
 * Description:带优先级的异步请求
 * </p>
 * <p>
 * 
 * </p>
 * 
 * @author zhangqy
 * @date 2016年5月11日下午3:23:13
 * 
 * @param <Params>
 * @param <Progress>
 * @param <Result>
 */
public abstract class PriorityAsyncTask<Params, Progress, Result> implements
		TaskHandler {
	protected static final String TAG = "PriorityAsyncTask";
	private static final int MESSAGE_POST_RESULT = 0x1;
	private static final int MESSAGE_POST_PROGRESS = 0x2;
	private static final InternalHandler sHandler = new InternalHandler();
	public static final Executor sDefaultExecutor = new PriorityExecutor();// 任务执行者
	private final WorkerRunnable<Params, Result> mWorker;// 任务
	private final FutureTask<Result> mFuture;// 对任务进行查询、取消等操作
	private final AtomicBoolean mCancelled = new AtomicBoolean();
	private final AtomicBoolean mTaskInvoked = new AtomicBoolean();
	private volatile boolean mExecuteInvoked = false;
	protected Boolean isDebug = HttpConfig.IS_SHOW_LOG;
	 ...
	 */
	public final PriorityAsyncTask<Params, Progress, Result> execute(
			Params... params) {
	 ...
	 * @see #execute(Object[])
	 */
	public final PriorityAsyncTask<Params, Progress, Result> executeOnExecutor(
