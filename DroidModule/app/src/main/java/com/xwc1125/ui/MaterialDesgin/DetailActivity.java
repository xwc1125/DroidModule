...
public class DetailActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.materialdesgin_detail_layout);

        position = getIntent().getIntExtra("pos", 0);
        actor = MaterialDesginActivity.actors.get(position);
...
//        getActionBar().setTitle(MaterialDesginActivity.actors.get(position).name);
