 ...
 */
public class MyRecyclerViewActivity
    extends Activity
{
    ...
    protected void onCreate( Bundle savedInstanceState )
    {
        ...
        setContentView(R.layout.materialdesgin_recycler_view);
...
//        getActionBar().setTitle("那些年我们追的星女郎");
        ...
        // 初始化自定义的适配器
        myAdapter = new MyRecyclerViewAdapter(this, actors);
        // 为mRecyclerView设置适配器
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_materialdesgin, menu);
        return true;
    }
