...
public final class CameraManager {
    ...
    private Rect framingRect;//扫描框的大小
    private Rect framingRectInPreview;

    private boolean initialized;//是否初始化了
    private boolean previewing;

    private int requestedFramingRectWidth;//扫描框的宽
    private int requestedFramingRectHeight;//扫描框的高
