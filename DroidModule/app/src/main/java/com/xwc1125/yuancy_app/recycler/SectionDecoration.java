...
public class SectionDecoration extends RecyclerView.ItemDecoration {
    ...
    public SectionDecoration(List<NameBean> dataList, Context context, DecorationCallback decorationCallback) {
        ...
        textPaint.setTextSize(20);//DensityUtil.dip2px(14)
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (groupId==null||groupId.equals("-1")) return;
        //只有是同一组的第一个才显示悬浮栏
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (groupId==null||groupId.equals("-1") || groupId.equals(preGroupId)) continue;
    ...
    private boolean isFirstInGroup(int pos) {
        if (pos == 0) {
            ...
            if (prevGroupId!=null&&prevGroupId.equals(groupId)) {
                return false;
            } else {
                return true;
            }
