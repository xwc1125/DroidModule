 ...
 *
 */
package com.xwc1125.droidutils.mms.util;
...
public class DrmConvertSession {
	 ...
	 *
	 * @param context
	 *            The context of the application running the convert session.
	 * @param mimeType
	 *            Mimetype of content that shall be converted.
	 ...
	 *
	 * @param inBuffer
	 *            Buffer filled with data to convert.
	 * @param size
	 *            The number of bytes that shall be converted.
	...
	public byte[] convert(byte[] inBuffer, int size) {
		...
		if (inBuffer != null) {
			...
			try {
				...
				if (convertedStatus != null && convertedStatus.statusCode == DrmConvertedStatus.STATUS_OK
