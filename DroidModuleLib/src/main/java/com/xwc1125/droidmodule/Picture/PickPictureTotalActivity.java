 ...
 */
public class PickPictureTotalActivity extends BaseAppCompatActivity {
    ...
    protected void setContentView(Bundle savedInstanceState) {
        setContentView(R.layout.pick_picture_total_activity);
    }
...
//        toolbar = (Toolbar) findViewById(R.id.public_top);
//        toolbarHelper = new ToolbarHelper(toolbar);
//        setSupportActionBar(toolbar);
//        getSupportActionBar().setDisplayShowTitleEnabled(false);
//        toolbarHelper.setTitleResId(R.string.pick_picture_total_title_album);
