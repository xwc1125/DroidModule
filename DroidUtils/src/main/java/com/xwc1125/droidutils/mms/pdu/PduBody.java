...
public class PduBody {
	 ...
	 * @date 2017年2月20日 下午1:57:02
	 */
	@Override
	public String toString() {
		return "PduBody [mParts=" + mParts + ", mPartMapByContentId=" + mPartMapByContentId
				+ ", mPartMapByContentLocation=" + mPartMapByContentLocation + ", mPartMapByName=" + mPartMapByName
				+ ", mPartMapByFileName=" + mPartMapByFileName + "]";
	}
