...
public class MyRecyclerViewAdapter
    ...
    public MyRecyclerViewAdapter(Context context, List<Actor> actors) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.mImageView.setImageDrawable(mContext.getResources().getDrawable(p.getImageResourceId(mContext)));
    }
